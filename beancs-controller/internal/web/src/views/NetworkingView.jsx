...
import { MetricCard, IngressForm, NetworkPolicyForm, SimpleTable, ServiceForm } from "../components/index";
import {
...
export default function NetworkingView({network, refresh, onSaveService, onDeleteService, onSaveIngress, onDeleteIngress, onSaveNetworkPolicy, onDeleteNetworkPolicy, onDetail}) {
