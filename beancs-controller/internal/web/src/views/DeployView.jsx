...
import { canContinueDeployStep, sourceLabel, sourceSummary, defaultDeployForm, indexForComponent, monorepoComponentHost, monorepoDefaultPrivateHost, definitionForDependency, dependencyDefaultConfig, uniqueDependencyName, imageName, imageReferenceFromTrackedImage, imageTagFromReference, slugify } from "../utils/index";
import { RepoListSkeleton, ApplicationSpecPlanSummary, DependencyConfigEditor, DependencyLinksEditor, EnvEditor, Field, ChevronIcon } from "../components/index";
import {
...
export default function DeployView({credentials, domains, namespaces, selectedCredential, setSelectedCredential, repos, selectedRepo, analysis, setAnalysis, form, setForm, loadRepos, analyzeRepo, checkInstallSource, deployProject, containerRegistries, containerImages, dependencyDefinitions, createTrackedImageFromDeploy, onConnectGitHub, reposLoading}) {
