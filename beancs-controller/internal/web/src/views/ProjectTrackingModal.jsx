...
import { formatDeploymentDate, normalizeDeploymentStatus, truncateMiddle } from "../utils/index";
...
export default function ProjectTrackingModal({project, tracking, loading, onRefresh, onClose}) {
