...
import { formatTime, formatBytes, formatKeyValues, taintsToForm } from "../utils/index";
import { ResourceMeter } from "../components/index";
import {
...
export default function NodeDetailView({detail, health, onLoadHealth, onSaveLabels, onSaveTaints, onCordon, onDrain, onDelete}) {
