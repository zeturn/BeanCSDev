...
import { processJobsFromRecord, progressJobs, filterLogLines, formatTime } from "../utils/index";
import { ProgressEvidence, ProgressStatusIcon, MetricCard } from "../components/index";
import {
...
export default function ProgressView({projects, processes, activeProcessID, setActiveProcessID, activeProjectID, setActiveProjectID, progress, installProgress, refresh, refreshList, logFollow, liveLogs, logStatus, onStartLogFollow, onStopLogFollow}) {
